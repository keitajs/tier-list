...
function ManagePermission({ activeList, setActiveList }) {
  ...
  return (
    <>
      ...
      :
        <div className='flex items-center justify-center text-center h-full opacity-50'>
          Jelenleg az új lista létrehozás van kiválasztva.<br />
          Kattints rá egy általad létrehozott listára, hogy módosítani tudjad.
        </div>
      }
    </>
  )
