      ...
      <div className='p-4 rounded-2xl bg-neutral-800'>
        ...
        <div className='flex gap-4'>
          <div className='flex flex-col justify-between gap-4'>
            <div className='flex items-center justify-center w-36 aspect-square rounded-xl text-base overflow-hidden' style={{background: color}}>{name}</div>
          ...
          <div className='flex flex-col gap-4'>
            <div className='relative flex flex-col gap-2 rounded-xl p-2.5 pt-2 pr-32 text-lg bg-neutral-900/35'>
              ...
              <div className='flex flex-col'>
                <label htmlFor="color" className='ml-1'>Szín</label>
