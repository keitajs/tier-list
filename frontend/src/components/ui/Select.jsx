...
export function SelectButton({ children, onClick, selected, color, className, icon, iconClassName }) {
  return (
    <button
      onClick={onClick}
    ...
    >
      ...
      <div className={`w-full py-1.5 rounded-lg ${selected ? (color || 'bg-blue-500') : 'bg-neutral-700/65'} transition-all`}>
        {children}
      </div>
    </button>
  )
