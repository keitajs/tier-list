  ...
  return (
    <div className={`z-40 fixed inset-0 flex items-center justify-center bg-neutral-950/60 ${hide ? 'opacity-0 pointer-events-none' : 'opacity-100 pointer-events-auto'} transition-opacity`}>
      <div className='p-4 rounded-2xl bg-neutral-800'>
        ...
        <Password name='pass1' type={'pwc'} value={password} value2={passwor2} setValue={setPassword} error={errors.password} setError={(e) => setError('password', e)} setError2={(e) => setError('passwor2', e)} reset={hide} margin='mt-6' />
        <Password label='Jelszó újra' name={'pass2'} type={'pc'} value={passwor2} value2={password} setValue={setPasswor2} error={errors.passwor2} setError={(e) => setError('passwor2', e)} reset={hide} margin='mt-6' />
        <Password label='Jelenlegi jelszó' value={currentPassword} setValue={setCurrentPassword} error={errors.currentPassword} setError={(e) => setError('currentPassword', e)} reset={hide} margin='mt-6' />
