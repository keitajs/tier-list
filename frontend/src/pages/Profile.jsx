      ...
      <div className='h-full ml-14'>
        <div className='flex flex-col gap-6 fixed right-6 top-6 bottom-6 w-1/5'>
          <div className='group relative aspect-square rounded-3xl bg-neutral-900/85 overflow-hidden'>
            <img src={"https://avatars.githubusercontent.com/u/126980311?v=4"} alt="" className='w-full h-full object-cover' />
            <div className='cursor-pointer absolute bottom-0 left-0 right-0 py-3 text-lg text-center bg-neutral-950 opacity-0 group-hover:opacity-35 hover:!opacity-90 transition-opacity'>Profilkép módosítás</div>
          </div>
          <div className='px-4 grow rounded-3xl bg-neutral-900/85'>
            <UserData user={user} list={list} history={props.history} />
          </div>
        </div>
